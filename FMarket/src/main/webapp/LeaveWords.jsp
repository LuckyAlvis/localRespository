        ...
        <section id="main">
                ...
                <%
          			if(!login){
            			...
            			out.print("<form action=\"LeaveWords.do\">物品名称：<a>"+article.getArticleName()+"</a><br><br>" +
            					"<input type=\"hidden\" name=\"oID\" value="+oid+"></input>" +
            					"<input type=\"hidden\" name=\"iID\" value="+iid+"></input>" +
            	                "留言内容：<input type=\"text\" style=\"width:600px; height=200px;\" placeholder=\"留言内容\" name=\"words\"></input> <br><br>" +
            	                "<button style=\"width:70px;\" class=\"but\" type=\"submit\">发送留言</button>" +
            	                "<button style=\"width:70px;\" class=\"but\" type=\"reset\">清空内容</button>" +
            	                "</form>");
            		}
                %>
                <br>
